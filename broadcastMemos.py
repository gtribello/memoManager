    ...
    for target_dir in os.listdir("Allstaff/") :
         ...
         for filename in os.listdir("Allstaff/" + target_dir) :
             ...
             with open("Allstaff/" + target_dir + "/" + filename, 'rb') as f :
                r3 = s.post( api_url + "/web/GetFolderByServerRelativeUrl('Disability/Memos/" + target_dir + "')/Files/add(url='" + filename + "')", headers = {"X-RequestDigest": form_digest},  files = {"file": f}) 
